...
/**
 * Our menu base class to provide everything for writing menus.
 * 
 *
 */
public class Menu {
	...
	/**
	 * Provide the menu title. This could be declared as an abstract method without
	 * a method body because it doesn't really do anything useful. As an abstract
	 * method, a sub-class would be forced to provide a real implementation (or
	 * body) of the method.
	 * 
	...
	/**
	 * Provide a menu description. This could be declared as an abstract method
	 * without a method body because it doesn't really do anything useful. As an
	 * abstract method, a sub-class would be forced to provide a real implementation
	 * (or body) of the method.
	 * 
	...
	/**
	 * Provide the list of menu items. This could be declared as an abstract method
	 * without a method body because it doesn't really do anything useful. As an
	 * abstract method, a sub-class would be forced to provide a real implementation
	 * (or body) of the method.
	 * 
	...
	/**
	 * Handle the user's menu selection. This could be declared as an abstract
	 * method without a method body because it doesn't really do anything useful. As
	 * an abstract method, a sub-class would be forced to provide a real
	 * implementation (or body) of the method.
	 * 
	 * @param key
